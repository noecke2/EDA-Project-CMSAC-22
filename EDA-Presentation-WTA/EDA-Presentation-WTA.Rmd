---
title: "Exploratory Data Analysis of WTA Matches"
...
- **49 variables from 10,701 observations**
...
```{r, echo = FALSE}
wta%>%
  select(tourney_name,tourney_date, surface, winner_name, loser_name, w_ace, w_df, w_bpSaved, w_bpFaced, w_1stIn, w_1stWon)%>%
  head(n = 5)%>%
  gt()
...
- Created two datasets using original `wta` dataset
...
## <center> Both minimax and complete linkage clustering were performed to analyze serve aggression </center>

* Variables of interest were **aces** and **double faults**
...
---
### There are few elite players who have high aces and low double faults
...
## <center>Minimax Clustering Reveals a Much Larger Cluster of the Weakest Players</center>
...
clusters_stats_minimax%>%
  ...
  labs(x = "Aces per Match",
       ...
       # subtitle = "There are few elite players who have high aces and low double faults",
       caption = "Minimax Clustering: Labeled\nplayers are cluster prototypes")
